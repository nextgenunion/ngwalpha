// ============================================================================
// NOTICE — READ THIS BEFORE YOU EDIT ANYTHING IN THIS PROJECT (humans + AI):
//
//   BUMP THE VERSION. FORMAT: MAJOR.MINOR.PATCH (e.g. 3.0.4 -> 3.0.5).
//
// If you (or an AI assistant) are shipping ANY changed file in this repo —
// a bug fix, a doc tweak, a "just a beta re-cut", anything — increment the
// PATCH digit of SONGBOOK_VERSION_NUMBER below AS PART OF THAT SAME EDIT.
// Not "beta.1" / "beta.2" / "beta.00000" — just the plain patch digit.
// There is no such thing as a change too small to bump for.
// This is the ONLY place a version number needs to be edited; see
// "Versioning scheme" in README.md for the full policy.
// ============================================================================
//
...
var SONGBOOK_VERSION_NUMBER = '4.0.11';
...
var SONGBOOK_VERSION_PRERELEASE = 'alpha';
