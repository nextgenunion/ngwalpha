...
window.SONGBOOK_LANG.en = {
  ...
  editorLyricsHint: "Tap the info button for simple formatting examples.",
  editorPreviewLabel: "Preview",
  editorPreviewEmpty: "Start typing lyrics above to see them rendered here.",
  editorFormatHelpAria: "Song formatting help",
  editorFormatHelpTitle: "How song formatting works",
  editorFormatHelpIntro: "Type lyrics normally. Use these simple marks only when you need them.",
  editorFormatHelpChordTitle: "Add a chord",
  editorFormatHelpChordBody: "Put the chord in [square brackets] exactly before the word or syllable where the chord changes.",
  editorFormatHelpSectionsTitle: "Start a new part",
  editorFormatHelpSectionsBody: "Leave one empty line between verses, choruses, bridges, or other parts.",
  editorFormatHelpLabelTitle: "Name a part",
  editorFormatHelpLabelBody: "At the start of a part, write a name followed by a colon, such as Chorus: or Bridge:. If you leave it unnamed, the app numbers the parts for you.",
  editorFormatHelpTypeLabel: "Type this",
  editorFormatHelpPreviewLabel: "Looks like this",
  editorFormatHelpExampleSource: "Verse: [G]Amazing [C]grace\nHow sweet the sound\n\nChorus: [G]I once was lost\nBut now am found",
